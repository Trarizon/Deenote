...
namespace Deenote.CoreB.Audio
{
    ...
    public sealed class DecodedClipProvider : IAudioClipProvider
    {
        public DecodedClipProvider(AudioClip clip)
        {
            Clip = clip;
        }
    ...
    public abstract class StreamingClipProvider : IAudioClipProvider
    {

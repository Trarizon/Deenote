...
{
    internal sealed class DsprojSerializer : IProjectSerializer
    {
        public static DsprojSerializer Instance { get; } = new();
        ...
        public Task SerializeAsync(ProjectModel project, string path, CancellationToken cancellationToken = default)
        {

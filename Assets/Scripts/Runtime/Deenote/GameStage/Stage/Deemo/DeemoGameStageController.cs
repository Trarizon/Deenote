...
namespace Deenote.GameStage.Stage.Deemo
{
    ...
    public sealed class DeemoGameStageController : GameStageController
    {
        ...
        protected internal override void Initialize(GameStageContext context)
        {
            ...
            context.PerspectiveViewPanelInfo.ViewSizeChanged += _OnViewSizeChanged;
            _OnViewSizeChanged(context.PerspectiveViewPanelInfo);
        }
        ...
        {
            _backgroundCamera.targetTexture = s.ViewRenderTexture;

...
namespace Deenote.GameStage.Stage.Deemo.Notes
{
    ...
    internal sealed class DeemoGameStageNoteController : GameStageNoteController
    {
        ...
        private DeemoGameStageController Stage => _deemoStage ??= (DeemoGameStageController)_context.GameStage!;
        ...
        protected override void OnNoteHeadKindChanged(NoteHeadKind kind)
        {
            var data = kind switch {
                ...
                NoteHeadKind.NoSound => _context.IsPianoNotesDistinguished ? Config.NoSoundNoteSpriteData : Config.ClickNoteSpriteData,

...
namespace Deenote.GameStage.Stage
{
    ...
    {
        protected GameStageContext _context;
        ...
        protected internal virtual void Initialize(GameStageContext context)
        {
            ...
            _context.PerspectiveViewPanelInfo.ViewSizeChanged += _OnViewSizeChanged;
            _OnViewSizeChanged(_context.PerspectiveViewPanelInfo);

            SelectionAreaRect.Initialize(MainSystem.StageDragSelector);
        }
        ...
        private void _OnViewSizeChanged(IPerspectiveViewPanelInfoProvider s)
        {
            ApplyCameraTargetTexture(s.ViewRenderTexture);
        }

        private void ApplyCameraTargetTexture(RenderTexture renderTexture)
        {
